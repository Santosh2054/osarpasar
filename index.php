...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" >
  ...
  <div class="container-fluid  top2 ">
   <div class="container top1">
     <div class="row">
	    <div class="col-sm-3">
	    <img class="img-responsive" src="images/logo.png" alt="Courier service "/>
		</div>
...
<footer class="container-fluid" style="background-color:rgb(26,26,26); width:100%;">
     <div class="container">
         <div class="row footer1">
		     <div class="col-sm-3">
			    <p>ABOUT US</p>
				 <label>OsarPasar  is a global supplier of transport and logistics solutions. We have offices in more than 20 countries and an international network of partners and agents.</label>
			 </div>
			 ...
			 <div class="col-sm-3">
				 ...
				 <ul class="list-unstyled">
				     <li>Global oasarpasar services based in Kathmandu, Nepal</li>
					 <li><br><br></li>
					  <li><img src="images/contact.png"> &nbsp +977-9860167259</li>
					  <li><img src="images/email.png"> &nbsp  santoshkatwal84@gmail.com </li>
					  <li><label>Kathmandu, Nepal</label></li>
				 </ul>
			 </div>
			...
			<div class="col-sm-6">
			<strong  style="float:left;color:gray;"> ©OsarPasar 2021.All right reserved</strong>
			</div>
